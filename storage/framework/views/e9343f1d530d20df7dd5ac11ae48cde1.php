    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 aos-init aos-animate" data-aos="fade-left" data-aos-easing="linear" data-aos-duration="600">
                <div class="about_img">
                    <img src="<?php echo e(asset('public/assets/images/about_bott.jpg')); ?>" alt="">
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="under_our_mission">
                    <div class="main_flex">
                        <div class="img-vision">
                            <img src="<?php echo e(asset('public/assets/images/png/vision-icon.png')); ?>" alt="vision-icon">
                        </div>
                        <div class="content">
                            <h3>Mission</h3>
            ...
            <div class="col-md-4 mb-3">
                <div class="under_our_mission">
                    <div class="main_flex">
                        <div class="img-vision">
                            <img src="<?php echo e(asset('public/assets/images/png/mission-icon.png')); ?>" alt="mission-icon">
                        </div>
                        <div class="content">
                            <h3>Vision</h3>
            ...
            <div class="col-md-4 mb-3">
                <div class="under_our_mission">
                    <div class="main_flex">
                        <div class="img-vision">
                            <img src="<?php echo e(asset('public/assets/images/png/values-icon.png')); ?>" alt="value-icon">
                        </div>
                        <div class="content">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quicmwmz/printerithelp.com/resources/views/frontend/about.blade.php ENDPATH**/ ?>