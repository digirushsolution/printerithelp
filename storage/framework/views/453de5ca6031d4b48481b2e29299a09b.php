    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="about_img">
                <img src="<?php echo e(asset('public/assets/images/brother_printer2.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 aos-init aos-animate" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="600">
                ...
                <div class="about_us_btn">
                        <div class="d-flex justify-content-lg-start justify-content-center mb-3">
                            <button class="common_btn text-white"><a href="<?php echo e(route('contact')); ?>">Contact us</a></button>
                        </div>
                </div>
            </div>
        </div>
...
<section class="about_section color_second py_8">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="about_img">
                <img src="<?php echo e(asset('public/assets/images/brother_printer3.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 mb-3">
                ...
                <img src="<?php echo e(asset('public/assets/images/brother_printer5.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quicmwmz/printerithelp.com/resources/views/frontend/brother_printer.blade.php ENDPATH**/ ?>