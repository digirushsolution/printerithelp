    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="about_img">
                <img src="<?php echo e(asset('public/assets/images/canon_printer2.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12">
...
<section class="about_section color_second py_8">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="about_img">
                <img src="<?php echo e(asset('public/assets/images/canon_printer3.jpg')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 mb-3">
                ...
                <img src="<?php echo e(asset('public/assets/images/canon_printer5.jpg')); ?>" alt="">
                </div>
            </div>
            <div class="col-md-6 mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/quicmwmz/printerithelp.com/resources/views/frontend/canon_printer.blade.php ENDPATH**/ ?>