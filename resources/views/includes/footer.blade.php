            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="d-flex gap-3">
                    <a href="#"><img src="{{ asset('public/assets/images/png/instagram.png') }}" alt="instagram"
                            class="social_icon"></a>
                    <a href="#"><img src="{{ asset('public/assets/images/png/whatsapp.png') }}" alt="whatsapp"
                            class="social_icon"></a>
                    <a href="#"><img src="{{ asset('public/assets/images/png/facebook.png') }}" alt="facebook"
                            class="social_icon"></a>
                </div>
            </div>
                    ...
                    <div class="col-sm-4 col-12 mt-3 mt-sm-0">
                        ...
                        <div class="d-flex gap-3 align-items-center pe-lg-5">
                            ...
                            <div>
                                ...
                                <a href="#" class="text-white fs_16 fw-normal">Lorem,
                                    ipsum dolor.</a>
                            </div>
                        </div>
                        <div class="d-flex gap-3 align-items-center mt-3">
                            ...
                            <div>
                                <p class="text-white fw-medium fs_18 mb-0">Mail Us</p>
                                <a href="#" class="text-white fs_16 fw-normal">contactus@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
