                    ...
                    <form id="contactForm" class="bg-light p-xl-5 p-sm-4 px-2 py-3 border_radius_6 position-relative overflow-hidden" method="POST" action="http://localhost/printer_it_help/submit-contact-form">
                        ...
                        <div class="position-relative z-1">
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                <button type="submit" class="common_btn text-white py-2 px-4 fw-medium mt-md-3 mt-2" tabindex="0">Enquiry Now</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<section class="our_services_main py_8">
    <div class="container">
        <h2 class="text-center aos-init aos-animate" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="600"><span class="text_blue">Our</span> Services</h2>
        <p class= text-center text-black mb-4 aos-init aos-animate" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="600">Lorem ipsum, dolor sit dolor sit amet Lorem ipsum
            dolor
